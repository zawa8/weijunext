...
export default async function Home() {
  const { posts, postsByMonth, }: { posts: WeeklyPost[]; postsByMonth: PostsByMonth } = await getWeeklyPosts();
  return (
    <div className="flex flex-row w-full pt-12">
      <div className="hidden md:block md:w-1/5 pl-6"></div>
	  <div className="w-full md:w-3/5 px-6"> <WeeklyList posts={posts} /> <DeveloperCard /> </div>
