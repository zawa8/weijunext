...
export type SiteConfig = {
  ...
  openGraph?: { type: string; locale: string; url: string; title: string; description: string; siteName: string; images?: string[]; };
  twitter?: { card: string; title: string; site: string; description: string; images?: string[]; creator: string; };
}
